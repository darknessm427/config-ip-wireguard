...
{{
        ...
        "outbounds": [
                ...
                {{
                "type": "wireguard",
                "tag": "IP->Main, ÐΛɌ₭ᑎΞ𐒡𐒡",
                "detour": "IP->Iran, ÐΛɌ₭ᑎΞ𐒡𐒡",
                "local_address": [
                        "172.16.0.2/32",
                        "{public_key2}"
                ],
...
def main3():
    ...
    {{
    "type": "wireguard",
    "tag": "𓄂𓆃 Warp-Main{wire_c}",
    "detour": "𓄂𓆃 Warp-IR{wire_c}",
    "server": "{best_result[0]}",
    "server_port": {best_result[1]},
...
def gojo_goodbye_animation():
    frames  = [
        "\n\033[94m(＾-＾)ノ\033[0m",  # blur
        "\n\033[93m(＾-＾)ノ~~~\033[0m",  # yellow
        "\n\033[92m(＾-＾)ノ~~~~~~\033[0m" , # green
    ]
